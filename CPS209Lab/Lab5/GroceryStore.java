...
public class GroceryStore
{
    ...
    public void addInventory(GroceryItem type, int amount)
    {
        ...
        if (type == GroceryItem.LETTUCE) this.lettuceInventory += amount;
        else if (type == GroceryItem.CUCUMBER) this.cucumberInventory += amount;
        else this.tomatoInventory += amount;
    ...
    public int getInventory(GroceryItem type)
    {
        ...
        if (type == GroceryItem.LETTUCE) return this.lettuceInventory;
        else if (type == GroceryItem.CUCUMBER) return this.cucumberInventory;
        else return this.tomatoInventory;
