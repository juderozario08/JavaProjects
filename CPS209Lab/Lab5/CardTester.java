...
public class CardTester
{
    ...
    public static String getCardInfo(DriversLicense card) {
        ...
        String mainString = "Name: " + card.getName() + ", ID: " + card.getID() + ", Expiry: " + card.getExpiryYear() + ", Type: ";
        if (DriversLicense.LicenseType.G1 == card.getLicenseType())
            return mainString + "G1";
        if (DriversLicense.LicenseType.G2 == card.getLicenseType())
            return mainString + "G2";
        else return mainString + "G";
